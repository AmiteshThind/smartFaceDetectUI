...
function Register(props) {
    ...
    let RegisterNewUser = () => {
        ...
        fetch('https://powerful-inlet-04840.herokuapp.com/register', {
            method: 'post',
            ...
            <article className="br3 ba  shadow-2 b--black-10 mv4  w-100 w-50-m w-25-l mw6 center">
                <main className="pa4 black-80">
                    <div className="measure ">
                        ...
                        <div className="">
                            <input onClick={RegisterNewUser} className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Register" />
                        </div>
